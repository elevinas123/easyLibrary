                                    ...
                                    <CardContent>
                                        <div className="space-y-2">
                                            <div className="flex justify-between items-center">
                                                <span className={isDarkMode ? "text-gray-400" : "text-gray-500"}>Current Streak</span>
                                                <span className="text-xl font-bold">{streak?.currentStreak || 0} days</span>
                                            </div>
                                            <div className="flex justify-between items-center">
                                                <span className={isDarkMode ? "text-gray-400" : "text-gray-500"}>Longest Streak</span>
                                                <span className="text-lg">{streak?.longestStreak || 0} days</span>
                                            </div>
                                            <div className="flex justify-between items-center">
                                                <span className={isDarkMode ? "text-gray-400" : "text-gray-500"}>Total Reading Days</span>
                                                <span className="text-lg">{streak?.totalReadDays || 0} days</span>
                                            </div>
                                        </div>
                                    </CardContent>
                                </Card>
                                            ...
                                            <div className="text-center space-y-1">
                                                <div className={cn(
                                                    ...
                                                    {stats?.totalReadingTime ? 
                                                        Math.floor(stats.totalReadingTime / 3600) : 0}
                                                </div>
                                                <div className={isDarkMode ? "text-gray-400" : "text-gray-500"}>
                                                    Hours Read
                                                </div>
                                                ...
                                                <div key={index} className="relative pl-6">
                                                    ...
                                                    <div className={cn(
                                                        ...
                                                        activity.type === 'completed' 
                                                            ? (isDarkMode ? "bg-green-900/30 text-green-500" : "bg-green-100 text-green-600")
                                                    ...
                                                    <div className="flex flex-col space-y-1 pb-4">
                                                        <div className="flex justify-between items-start">
                                                            <div>
                                                                ...
                                                                >
                                                                    {activity.type === 'completed' ? 'Completed' : 'Read'}
                                                                </Badge>
                                                            </div>
                                                            <span className={cn(
                                                                "text-xs",
                            ...
                            <Card className={cn(
                                ...
                                <CardContent>
                                    <div className="text-center py-8">
                                        <p className={isDarkMode ? "text-gray-400" : "text-gray-500"}>
                                            Detailed reading statistics charts will be implemented here.
                                        </p>
                                    </div>
                                </CardContent>
                            </Card>
                                ...
                                <Card className={cn(
                                    ...
                                    <CardContent>
                                        {bookProgress?.filter(p => p.isCompleted).length ? (
                                            <div className="space-y-4">
                                                {bookProgress.filter(p => p.isCompleted).map((progress) => (
                                                    <div 
                                                        key={progress.id} 
                                                        className={cn(
                                                        ...
                                                        onClick={() => navigate(`/book?id=${progress.book.id}`)}
                                                    >
                                                        <img 
