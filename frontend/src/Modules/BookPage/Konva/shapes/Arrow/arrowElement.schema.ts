...
import {CurveElementSkeleton, CurveElementSkeletonSchema, CurveElementSkeletonType,} from './curveElementSkeleton';
...
@Schema({_id: false})
export class ArrowElement extends CurveElementSkeleton implements
    ArrowElementType {
