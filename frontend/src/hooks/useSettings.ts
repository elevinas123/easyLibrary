...
import {CreateSettingsDto, UpdateSettingsDto,} from '../../../backend/src/settings/settings.dto';
...
export const useSettings = () => {
  ...
  const updateSettings =
      useCallback(async (updatedSettings: UpdateSettingsDto) => {
        if (!user || !accessToken) {
        ...
        try {
          ...
          await updateSettingsFunc(accessToken, user._id, updatedSettings);
