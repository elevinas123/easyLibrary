...
import {HighlightSchema, HighlightType,} from '../../../../frontend/src/Modules/BookPage/Konva/modules/BookTextLayers/highlights.schema';
import {OffsetPositionSchema, OffsetPositionType,} from '../../../../frontend/src/Modules/BookPage/Konva/offsetPosition.schema';
import {ArrowElementType} from '../../../../frontend/src/Modules/BookPage/Konva/shapes/Arrow/arrowElement.schema';
import {CurveElementSkeletonSchema} from '../../../../frontend/src/Modules/BookPage/Konva/shapes/Arrow/curveElementSkeleton';
import {CanvaElementSkeletonSchema, CanvaElementType,} from '../../../../frontend/src/Modules/BookPage/Konva/shapes/canvaElementSkeleton.schema';
